...
function Profile() {
  ...
  return (<div>
    ...
    <div className="grid">
      <div className="itm">
        <img className="housePic" onClick={toggleShow}
          src="https://images.pexels.com/photos/2079234/pexels-photo-2079234.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
          alt="post pic"
        ></img>
        <div className="houseDetails">
          <div className="det" style={{ display: (show) ? "flex" : "none" }}><h2>Price</h2> <p>10000</p></div>
          <div className="det" style={{ display: (show) ? "flex" : "none" }}><h2>Size</h2> <p>3.4 sq m</p></div>
          <div className="det" style={{ display: (show) ? "flex" : "none" }}><h2>Bedroom</h2> <p>3</p></div>
        </div>
      </div>
      <div className="itm">
        <img className="housePic" onClick={toggleShow}
        ...
        ></img>
          ...
          { show && 
            <div className="houseDetails">
            <div className="det" ><h2>Price</h2> <p>10000</p></div>
            <div className="det" ><h2>Size</h2> <p>3.4 sq m</p></div>
            <div className="det" ><h2>Bedroom</h2> <p>3</p></div>
          </div>}
